...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.printf("Размер пустой строки = %d байт на %d итерациях, рост памяти за элемент = %d байт%n", stringSize.initSize, stringSize.iterCount, stringSize.addedSizePerIter);

        MemoryMeasurement.MeasurementResult arraySize = MemoryMeasurement.makeMeasurement(()->new int[10000], (ar, i)->ar[i] = i);
        System.out.printf("Размер int[10000] массива = %d байт на %d итерациях, рост памяти за элемент = %d байт%n", arraySize.initSize, arraySize.iterCount, arraySize.addedSizePerIter);
